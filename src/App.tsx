              ...
              >
                ...
                {activeTab === 'practice' && practiceExercise && (
                  <div className="space-y-8">
                    ...
                    <section className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
                      <h3 className="text-xl font-bold text-zinc-900 mb-2">Nộp bài làm của em</h3>
                      <p className="text-zinc-500 text-sm mb-6">Em hãy chọn 1 trong 2 cách: mô tả cách làm hoặc tải lên file dự án (.sb3)</p>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div className="space-y-4">
                          <label className="block text-sm font-bold text-zinc-700">Cách 1: Mô tả cách làm hoặc ý tưởng</label>
                          <textarea
                            value={studentInput}
                        ...
                        <div className="space-y-4">
                          <label className="block text-sm font-bold text-zinc-700">Cách 2: Tải lên file dự án (.sb3)</label>
                          <div className="relative h-40">
                            <input
                              type="file"
                              accept=".sb3"
                ...
                {activeTab === 'challenge' && challenge && (
                  <div className="space-y-8">
                    ...
                    <section className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-sm">
                      <h3 className="text-xl font-bold text-zinc-900 mb-2">Gửi bài làm của em</h3>
                      <p className="text-zinc-500 text-sm mb-6">Em hãy chọn 1 trong 2 cách: mô tả cách làm hoặc tải lên file dự án (.sb3)</p>
                      
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <label className="block text-sm font-bold text-zinc-700">Cách 1: Mô tả cách em xây dựng chương trình</label>
                            <textarea
